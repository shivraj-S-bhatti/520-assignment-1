"""
Test suite for Gemini 2.0 Flash solutions from Assignment 1.
Tests all 10 problems using solutions from src/ directory.
"""
...
def test_gemini_solution(problem):
    """Test Gemini solution for a specific problem."""
    try:
        ...
        pytest.skip(f"Could not import {problem} from src/: {e}")
